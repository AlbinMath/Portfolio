...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.location.href = `mailto:albinmathew0602@gmail.com?subject=${subject}&body=${body}`
  }
  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-4xl">
        ...
        <div
          className={`bg-white rounded-2xl shadow-xl p-8 md:p-12 hover-lift transition-all duration-500 ${
            sectionVisible ? 'opacity-100 animate-scale-in' : 'opacity-0 scale-90'
          }`}
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:albinmathew0602@gmail.com" className="text-primary-600 hover:text-primary-700">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+919496176348" className="text-primary-600 hover:text-primary-700">
                    +919496176348
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Alakode, Kerala, India - 670571</p>
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-gray-200">
                ...
                <div className="flex gap-4">
                  <a
                    href="https://www.linkedin.com/in/albinmathew2002"
                    target="_blank"
                  ...
                  <a
                    href="https://github.com/AlbinMath"
                    target="_blank"
                    rel="noopener noreferrer"
